  ...
  render() {
    return (
      <div className='Intro mdl-shadow--4dp' >
        <p className='mdl-typography--caption'>На важнейшие жизненные вопросы отвечают представители различных религий и мировоззрений. Узнайте какое из них Вам ближе.</p>
