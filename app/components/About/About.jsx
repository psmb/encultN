...
export default class About extends Component {
  render() {
    return (
      <div className='About marginTop-double fixed-width'>
        <div className='row'>
          <div className='medium-8 columns'>
            <h1 className='marginVertical-double mdl-typography--display-1-color-contrast'>О проекте</h1>
            <p className='mdl-typography--body-1-color-contrast'>Проект осуществляется автономной некоммерческой организацией "Центр изучения и развития межкультурных отношений"</p>
          </div>
        </div>
        <div className='row'>
